...
## Design Approach
**Reference-Based**: Modern B2B e-commerce inspired by Shopify, Grainger, and contemporary industrial produto catalogs. Clean, trust-building layouts that showcase technical produtos professionally while maintaining approachability.
...
- **Hierarchy**:
  ...
  - Produto Titles: xl-2xl, font-semibold (24-32px)
  - Body Text: base-lg, font-normal (16-18px)
  - Produto Specs: sm-base, font-medium (14-16px)
...
- Categories dropdown for produto types
...
- CTAs: Primary "Browse Produtos" + Secondary "Request Quote"

### Produto Grid
- 3-column desktop (lg:grid-cols-3), 2-column tablet (md:grid-cols-2), 1-column mobile
- Produto cards with:
  - Square produto image (aspect-square)
  - Produto name and model number
...
- Below fold: Related produtos carousel, technical documentation downloads
...
- Lifestyle images showing produtos in use for featured items
...
- Lazy loading for produto images
- Filter updates with subtle fade transitions
- Produto card hover states with scale and shadow
- Sticky "Request Quote" button on produto detail pages (appears after scroll)
...
- Alt text for all produto images with model numbers

This creates a professional, trustworthy industrial produto showcase with modern e-commerce UX while maintaining technical credibility.